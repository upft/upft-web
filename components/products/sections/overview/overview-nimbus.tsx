...
export default function OverviewNimbus() {
  return (
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2">
          <div className="hero-left-content px-4 md:px-8 order-2 md:order-1">
            ...
            <div className="block md:hidden w-full mt-8 ">
              <button className="w-full rounded px-12 py-2 bg-white text-black font-bold border-white border-2 ">
                Learn more
              </button>
            </div>
          </div>
          <div className="hero-right-content text-start px-4 order-1 md:order-2">
            ...
            <div className="hidden md:block w-full px-8 mt-8 ">
              <button className="rounded px-12 py-2 bg-blue text-white border-white border-2 ">
                Learn more
              </button>
            </div>
          </div>
