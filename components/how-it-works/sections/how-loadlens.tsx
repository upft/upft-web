...
export default function HowLoadLens() {
  return (
          ...
          <div data-aos="fade-left" className="how-it-works-left">
            <h2>
              <span className=" how-it-works-txt-effect -ml-2 lg:-ml-8 px-2 lg:px-8">
                ...
                Set up foreign keys and data generation types For LoadLens
              </span>
            </h2>
          ...
          <div data-aos="fade-left" className="how-it-works-left">
            <h2>
              <span className=" how-it-works-txt-effect -ml-2 lg:-ml-8 px-2 lg:px-8">
                ...
                Select the number of data entries you want to be generated For
                LoadLens
              </span>
            </h2>
            <p className="py-6 pr-8">
          ...
          <div data-aos="fade-left" className="how-it-works-left">
            <h2>
              <span className=" how-it-works-txt-effect -ml-2 lg:-ml-8 px-2 lg:px-8">
                ...
                Connect to the database For LoadLens
              </span>
            </h2>
            <p className="py-6 pr-8">
