        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-4 gap-12 my-12">
          <div className="hero-grid-item">
            ...
            <p className="hero-grid-text">
              One platform for streamlined testing across departments
            </p>
          </div>
          <div className="hero-grid-item">
            ...
            <p className="hero-grid-text">
              Eliminates the needs for manual data seeding and environment
              management
            </p>
          </div>
          <div className="hero-grid-item">
            ...
            <p className="hero-grid-text">
              Realistic test data and dedicated environments for reliable
              testing.
            </p>
          </div>
          {/* <div className="hero-grid-item">
